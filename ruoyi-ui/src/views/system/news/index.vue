<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="来源地址" prop="resourceurl">
        <el-input
      ...
      <el-form-item label="发布人" prop="createuer">
        <el-input
          v-model="queryParams.createuer"
          placeholder="请输入发布人"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="newsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="来源" align="center" prop="resource" />
      <el-table-column label="来源地址" align="center" prop="resourceurl" />
      <el-table-column label="内容" align="center" prop="content" />
      <el-table-column label="是否展示" align="center" prop="isshow" />
      <el-table-column label="发布人" align="center" prop="createuer" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="来源地址" prop="resourceurl">
          <el-input v-model="form.resourceurl" placeholder="请输入来源地址" />
        </el-form-item>
        ...
        <el-form-item label="发布人" prop="createuer">
          <el-input v-model="form.createuer" placeholder="请输入发布人" />
        </el-form-item>
        <el-form-item label="是否删除(0,1)" prop="isdel">
